...
from model import Transformer, BiLstm_Model, Lstm_Model, Rnn_Model, TextCNN_Model, RCNN_Model
...
class Niubility:
    def __init__(self, args, logger):
        ...
        elif args.method_name == 'rcnn':
            self.Mymodel = RCNN_Model(base_model, args.num_classes)
        else:
